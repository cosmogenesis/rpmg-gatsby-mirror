...
import styles from "src/assets/jss/material-kit-react/views/componentsPage/sections/basicsStyle.js"
        ...
        <div id="buttons">
          ...
          <GridContainer justify="center">
            <GridItem xs={12} sm={12} md={8}>
              ...
              <Button color="dashboard">dashboard</Button>
            </GridItem>
          </GridContainer>
        </div>
        ...
        <div id="sliders">
          <GridContainer>
            ...
            <GridItem xs={12} sm={12} md={6}>
              ...
              <Badge color="dashboard">dashboard</Badge>
            </GridItem>
          </GridContainer>
        </div>
      </div>
