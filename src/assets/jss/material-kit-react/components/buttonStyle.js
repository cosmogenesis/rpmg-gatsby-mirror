...
const buttonStyle = {
  ...
  primary: {
    ...
    boxShadow:
      "0 4px 5px 0 rgba(24, 103, 166, 0.14), 0 1px 10px 0 rgba(24, 103, 166, 0.12), 0 2px 4px -1px rgba(24, 103, 166, 0.2)",
    "&:hover,&:focus": {
      backgroundColor: primaryColor,
      boxShadow:
        "0 14px 26px -12px rgba(24, 103, 166, 0.42), 0 4px 23px 0px rgba(0, 0, 0, 0.12), 0 8px 10px -5px rgba(24, 103, 166, 0.2)",
    },
  },
  info: {
